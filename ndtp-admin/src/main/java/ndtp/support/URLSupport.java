...
public class URLSupport {
	...
	public static final String SIGNIN_URL = "/signin/signin";
	public static final String POPUP_SIGNIN_URL = "/signin/popup-signin";
	public static final String POPUP_URL = "popup";
	
	// login 의 경우 통과
	public static final String[] EXCEPTION_URI = { "error", "signin", "/api/", "swagger" };
	public static final String[] USER_STATUS_EXCEPTION_URI = { "/signin/signin", "/signin/process-signin", "/user/modify-password", "/user/update-password"};
