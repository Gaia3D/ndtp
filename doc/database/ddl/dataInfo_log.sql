...
drop table if exists data_info_log_2019 cascade;
...
comment on column data_info_log.before_location is '변경전 위치';
comment on column data_info_log.before_altitude is '변경전 높이';
...
comment on column data_info_log.status is '상태. request : 요청, approval : 승인, reject : 기각, rollback : 원복';
comment on column data_info_log.change_type is '변경 유형';
...
create table data_info_log_2019 partition of data_info_log for values from ('2019-01-01 00:00:00.000000') to ('2020-01-01 00:00:00.000000');
