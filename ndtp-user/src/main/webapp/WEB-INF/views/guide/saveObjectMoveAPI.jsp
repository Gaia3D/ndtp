<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div id="api10" class="apihelptoggle" style="display: none;">
	<div class="menu_tab">
		<ul>
	...
	<div class="paramContainer">
		...
		<input
			type="button" value="Run" class="popupBtn" onclick="saveObjectMove()">
	</div>
...
<script>
	var saveObjectMove = function() {
		...
		var p1 = $("input[name=api10-p1]:checked").val();

		saveObjectMoveAPI(MAGO3D_INSTANCE2, p1);
	}
</script>