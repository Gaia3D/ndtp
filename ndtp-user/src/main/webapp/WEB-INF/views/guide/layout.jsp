			...
			<div class="descript">
				<div class="popupGroup">
					<div id="testtoggle">
						...
						<%@ include file="/WEB-INF/views/api-help/changePropertyRenderingAPI.jsp"%>
						<%@ include file="/WEB-INF/views/api-help/changeShadowAPI.jsp"%>
						<%@ include file="/WEB-INF/views/api-help/changeColorAPI.jsp"%>
						<%@ include file="/WEB-INF/views/api-help/changeLocationAndRotationAPI.jsp"%>
						...
						<%@ include file="/WEB-INF/views/api-help/deleteAllChangeColorAPI.jsp"%>
						<%@ include file="/WEB-INF/views/api-help/changeInsertIssueModeAPI.jsp"%>
						<%@ include file="/WEB-INF/views/api-help/changeObjectInfoViewModeAPI.jsp"%>
						<%@ include file="/WEB-INF/views/api-help/changeOcclusionCullingAPI.jsp"%>
						<%@ include file="/WEB-INF/views/api-help/changeFPVModeAPI.jsp"%>
						<%@ include file="/WEB-INF/views/api-help/changeNearGeoIssueListViewModeAPI.jsp"%>
						<%@ include file="/WEB-INF/views/api-help/changeInsertIssueStateAPI.jsp"%>
						...
						<%@ include file="/WEB-INF/views/api-help/drawInsertIssueImageAPI.jsp"%>
						...
						<%@ include file="/WEB-INF/views/api-help/getDataInfoByDataKeyAPI.jsp"%>
						<%@ include file="/WEB-INF/views/api-help/drawAppendDataAPI.jsp"%>
						<%@ include file="/WEB-INF/views/api-help/gotoFlyAPI.jsp"%>
						<%@ include file="/WEB-INF/views/api-help/getCoordinateRelativeToBuildingAPI.jsp"%>
						<%@ include file="/WEB-INF/views/api-help/getAbsoluteCoodinateOfBuildingPointAPI.jsp"%>
						<%@ include file="/WEB-INF/views/api-help/getCameraCurrentPositionAPI.jsp"%>
						<%@ include file="/WEB-INF/views/api-help/getCameraCurrentOrientaionAPI.jsp"%>
						<%@ include file="/WEB-INF/views/api-help/changeCameraOrientationAPI.jsp"%>
						<%@ include file="/WEB-INF/views/api-help/instantiateStaticModelAPI.jsp"%>
						...
						<%@ include file="/WEB-INF/views/api-help/togglePointCloudColorAPI.jsp"%>
					</div>
				</div>
			</div>
		</div>
