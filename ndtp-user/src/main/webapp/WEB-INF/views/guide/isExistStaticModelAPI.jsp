<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div id="api40" class="apihelptoggle" style="display: none;">
	<div class="menu_tab">
		<ul>
	...
	<div class="paramContainer">
		<p>projectId :</p>
		<input type="text" id="api40-p1" value="static_sample"></div></br> <input
			type="button" value="Run" class="popupBtn" onclick="isExistStaticModel()">
...
<script>
	var isExistStaticModel = function() {
		...
		var r1 = isExistStaticModelAPI(MAGO3D_INSTANCE2, p1);
		document.getElementById("api40-result").innerText = r1.toString();
	}
</script>