<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div id="api18" class="apihelptoggle" style="display: none;">
	<div class="menu_tab">
		<ul>
	...
	<h2>changeInsertIssueStateAPI</h2>
		...
		<tr><td>insertIssueState</td><td>String</td><td>이슈 등록 좌표 상태</td></tr>
		</table></br>
		<h4>실행</h4>
	<div class="paramContainer">
		<p>insertIssueState :</p>
		<input type="text" id="api18-p1" value="0"></div></br> 
...
<script>
	var changeInsertIssueState = function() {
		...
		changeInsertIssueStateAPI(MAGO3D_INSTANCE2, parseFloat(p1));
	}
</script>