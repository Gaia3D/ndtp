<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div id="api3" class="apihelptoggle" style="display: none;">
	<div class="menu_tab">
		<ul>
	...
	<h2>changeOriginAPI</h2>
		...
		<label><input type="radio" name="api3-p1" value="false" checked />비활성</label></div></br>
...
<script>
	var changeOrigin = function() {
		...
		var p1 = $("input[name=api3-p1]:checked").val();
