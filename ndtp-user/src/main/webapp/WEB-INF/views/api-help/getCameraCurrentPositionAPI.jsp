<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div id="api34" class="apihelptoggle" style="display: none;">
	<div class="menu_tab">
		<ul>
	...
	<p>현재 카메라의 위치를 구하는 API입니다.</p>
		...
		<tr><td>unit</td><td>Number</td><td>위치 단위 (기본값 : 1)
											0 : 미터, 1 : 도(degree), 
											2 : 라디안(radian)</td></tr>
		</table><br>
		<h4>리턴</h4>
		...
		<tr><td>object</td><td>현재 카메라의 위치</td></tr>
		</table><br>
		<h4>실행</h4>
	<div class="paramContainer">
		...
		<label><input type="radio" name="api34-p1" value="2" checked />라디안</label></div></br> 
		<input
			type="button" value="Run" class="popupBtn" onclick="getCameraCurrentPosition()">
			<table id="api34-result">결과 :</table>
	</div>
...
<script>
	var getCameraCurrentPosition = function() {
		...
		var p1 = $("input[name=api34-p1]:checked").val();

		var r1 = getCameraCurrentPositionAPI(MAGO3D_INSTANCE2, parseFloat(p1));
