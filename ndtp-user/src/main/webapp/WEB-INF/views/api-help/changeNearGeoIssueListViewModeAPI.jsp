<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div id="api17" class="apihelptoggle" style="display: none;">
	<div class="menu_tab">
		<ul>
	...
	<h2>changeNearGeoIssueListViewModeAPI</h2>
		...
		<label><input type="radio" name="api17-p1" value="false" checked />비활성</label></div></br> 

		<input type="button" value="Run" class="popupBtn" 
			onclick="changeNearGeoIssueListViewMode()">
	</div>
...
<script>
   var changeNearGeoIssueListViewMode = function() {
      ...
      var p1 = $("input[name=api17-p1]:checked").val();
