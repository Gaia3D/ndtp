<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div id="api26" class="apihelptoggle" style="display: none;">
	<div class="menu_tab">
		<ul>
	...
	<p>프로젝트 아이디(projectId)와 데이터 고유키(dataKey)에 해당하는 지도 상의 데이터를 찾아 이동하는 API입니다.</p>
		<h4>파라미터</h4>
		<table>
	...
	<div class="paramContainer">
		...
		<p>dataKey :</p>
		<input type="text" id="api26-p2" value="SOCIALROOM"></div></br> <input
			type="button" value="Run" class="popupBtn" onclick="searchData()">
	</div>
...
<script>
	var searchData = function() {
		...
		searchDataAPI(MAGO3D_INSTANCE2, p1, p2);
	}
</script>