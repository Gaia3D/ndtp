<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div id="api42" class="apihelptoggle" style="display: none;">
	<div class="menu_tab">
		<ul>
	...
	<div class="paramContainer">
		...
		<p>dataKey :</p>
		<input type="text" id="api42-p2" value="SOCIALROOM"></div></br> <input
			type="button" value="Run" class="popupBtn" onclick="isDataReadyToRender()">
...
<script>
	var isDataReadyToRender = function() {
		...
		var r1 = isDataReadyToRenderAPI(MAGO3D_INSTANCE2, p1, p2);
		
		document.getElementById("api42-result").innerText = r1.toString();
