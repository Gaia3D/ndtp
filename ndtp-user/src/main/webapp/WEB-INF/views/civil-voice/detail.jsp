...
<div id="civilVoiceDetailContent" class="contents mar0 pad0 border-none" style="display:none;">
	<div class="commentView">
		...
		<div class="con"><!-- max-height:250px, 자동 스크롤 생김 -->
			예로부터 모든 인간 공동체는 다른 동물 혹은 자기 공동체에 속하지 않은 다른 인간과 경계를 지으면서 살아왔다. 모든 사회가 규정하는 ‘인간’ 개념의 의미는, 잠재적으로나 노골적으로나 자신이 속한 무리의 일원에게 한정되어 있다. 인간에게 외부인은 종류가 다른 인간이자 문명화되지 못한, 때로는 거칠고 야만적이기까지 한 대상이며, 이 모든 것을 통틀어 ‘매너가 없다’라고 표현한다.‘인간답다’라는 것은, 적절하게 처신한다는 뜻이며 상황에 맞는 몸짓을 하며 정해진 때에 정해진 말을 한다는 의미다. 적절하게 처신한다는 뜻이며 상황에 맞는 몸짓을 하며 정해진 때에 정해진 말을 한다는 의미다.
		</div>
	</div>
